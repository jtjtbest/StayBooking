...
//makes sure the Jackson library will use the Builder class to convert JSON format data to the Stay object.
...
public class Stay implements Serializable {
    ...
    // cascade: add delete stay with update stayimage table
    private List<StayImage> images;


    public Stay() {}

    private Stay(Builder builder) { //这样不需要n个contructor
        this.id = builder.id;
